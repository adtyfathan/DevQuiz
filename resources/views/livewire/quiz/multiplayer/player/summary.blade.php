<div>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold">{{ $completedQuiz->multiplayerQuiz->show_score ? number_format($accuracy, 1) . '%' : '-' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xl font-bold">{{ $completedQuiz->multiplayerQuiz->show_score ? number_format($point) : '-' }}</p>
                        </div>
                    </div>
                </div>
            ...
            @if ($completedQuiz->multiplayerQuiz->show_score)
                <!-- Answer Statistics -->
                        ...
                        <div class="text-center">
                            <div class="relative w-16 h-16 mx-auto mb-3">
                                ...
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span class="text-xs font-semibold text-blue-600">{{ number_format($accuracy, 0) }}%</span>
                                </div>
                            </div>
            ...
            @if ($completedQuiz->multiplayerQuiz->show_review)
                <!-- Questions Review -->
